                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST" action="{{ route('login-submit')}}">
                                        ...
                                        <div class="form-group">
                                            <input type="email" class="form-control @error('email') is-invalid @enderror form-control-user" name="email" value="{{ old('email') }}"
                                    ...
                                    {{-- <div class="text-center">
                                        <a class="small btn btn-secondary" href="{{route('landing-page')}}">Back</a>
                                    </div> --}}
                                </div>
                            </div>
                        </div>
