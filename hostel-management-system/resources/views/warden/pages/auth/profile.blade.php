...
<div class="container-fluid">
    <div class="container">
        ...
        <div class="row" id="filter-panel">
            <div class="col-12">
                <div class="my-3 p-3 bg-white rounded shadow-sm">
                    {{-- <form action="{{route('warden.profile.details_update',$user->id)}}" method="post">
                        @csrf
                        @method('PUT') --}}
                        <div class="row">
                        ...
                        {{-- <div class="row border-top-1 m-0 pt-4 mt-2">
                            <div class="col-12 col-md-3 offset-md-3 d-flex">
                                <button type="button" class="btn btn-light w-100 mx-1" onclick="window.location.replace(`{{ route('warden.home') }}`)">Back</button>
        ...
        <div class="row" id="filter-panel">
            <div class="col-12">
                <div class="my-3 p-3 bg-white rounded shadow-sm">
                    <form action="{{route('warden.profile.update',$user->id)}}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="row">
