...
<div class="content-header">
    <div class="container-fluid">
        <ol class="d-flex breadcrumb bg-transparent p-0 justify-content-end">
            <li class="breadcrumb-item text-capitalize"><a href="/sub-warden/home">Home</a></li>
...
<div class="container-fluid">
    <div class="container">
        ...
        <div class="row" id="filter-panel">
            <div class="col-12">
                <div class="my-3 p-3 bg-white rounded shadow-sm">
                    {{-- <form action="{{route('sub-warden.profile.details_update',$user->id)}}" method="post">
                        @csrf
                        @method('PUT') --}}
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="mb-3 text-left">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name',$user->firstname) }}" >
                                    @error('name')
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-3 text-left">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name',$user->lastname) }}" >
                                    @error('name')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        {{-- <div class="row border-top-1 m-0 pt-4 mt-2">
                            <div class="col-12 col-md-3 offset-md-3 d-flex">
                                <button type="button" class="btn btn-light w-100 mx-1" onclick="window.location.replace(`{{ route('sub-warden.home') }}`)">Back</button>
        ...
        <div class="row" id="filter-panel">
            <div class="col-12">
                <div class="my-3 p-3 bg-white rounded shadow-sm">
                    <form action="{{route('sub-warden.profile.update',$user->id)}}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="row">
