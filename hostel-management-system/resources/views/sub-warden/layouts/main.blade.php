...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('sub-warden.home')}}">
                {{-- <div class="sidebar-brand-icon rotate-n-15 bg-rounded">
                    <img src="{{asset('img/logo.ico')}}" alt="logo.png" class="rounded-circle bg-light">
                </div> --}}
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item {{ (request()->is('sub-warden.home*')) ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('sub-warden.home') }}">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="{{route('sub-warden.profile.index')}}">
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="logout-form" action="{{ route('sub-warden.logout') }}" method="POST" class="d-none">
                    @csrf
                </form>
